...
do
  ...
  -- Limit textwidth on comments but not text, still gq can be used to format (perso)
  vim.o.textwidth = 80
...
do
  ...
  require('blink.cmp').setup {
    keymap = {
      ...
      -- <c-e>: Hide menu
      -- <c-k>: Toggle signature help -- NOTE: problem comes from here
      --
...
-- Run hpack after modifying package.yaml
local function hpack()
  local file = vim.fn.expand '%'
  local output = vim.fn.system('hpack ' .. file)
